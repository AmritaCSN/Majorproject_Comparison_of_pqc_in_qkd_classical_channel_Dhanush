...
try:
    from kyber.aes256_ctr_drbg import AES256_CTR_DRBG
...
class Kyber:
    ...
    def set_drgb_seed(self, seed):
        ...
        """
        self.drgb = AES256_CTR_DRBG(seed)
    ...
    def reseed_drgb(self, seed):
        ...
        if self.drgb is None:
            raise Warning(
                f"Cannot reseed DRGB without first initialising. Try using `set_drgb_seed`"
            )
        else:
    ...
    def enc(self, pk, m, key_length=48):
        """
    ...
    def dec(self, c, sk, key_length=48):
        """
